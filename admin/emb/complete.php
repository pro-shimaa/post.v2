...
include"e/menu.php";//define total number of results you want per page  
    ...
    $query = "select *from temp where status=6";  
    ...
    $query = "SELECT *FROM temp where status=6 LIMIT " . $page_first_result . ',' . $results_per_page;  
    $result = mysqli_query($post, $query);  
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">الطلاب الموافق عليهم من مجلس الكلية</h1>
...
<?php 
        ...
        echo '<a href = "complete.php?page=' . $page . '">' . $page . ' </a>';  
    }  
