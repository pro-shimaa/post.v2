...
include"e/menu.php";//define total number of results you want per page  
    ...
    $query = "select *from temp where status=1 and dept_id=3";  
    ...
    $query = "SELECT *FROM temp where status=1 and dept_id=3 LIMIT " . $page_first_result . ',' . $results_per_page;  
    $result = mysqli_query($post, $query);  
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header"  style="color:#900">الطلاب المكتملة اوراقهم بقسم الهندسة الكهربية</h1>
...
<?php 
        ...
        echo '<a href = "elec.php?page=' . $page . '">' . $page . ' </a>';  
    }  
  ...
  <form class="form-horizontal" action="el.php" method="post" name="upload_excel"  
