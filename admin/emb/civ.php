...
$sql = "SELECT arabic_name,english_name,dept_name,degree,email,birthdate,country,address,phone_mobile,id_number,special,grade,grade_year,grad_place FROM all_data where status=1 and  dept_id=1"; 
